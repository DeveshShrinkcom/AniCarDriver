...
class PaymentScreenState extends State<PaymentScreen> {
 ...
 /* void payPalPayment() async {
  ...
  /// Mercado Pago paymentF
  void mercadoPagoPayment() async {
    var body = json.encode({
      "items": [
        {"title": "Ani Cars Rider", "description": "Ani Cars Rider", "quantity": 1, "currency_id": appStore.currencyName.toUpperCase(), "unit_price": widget.amount}
      ],
